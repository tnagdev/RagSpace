...
class RabbitMQConsumer:
    ...
    def __init__(self) -> None:
        ...
        self.exchange_name: str = settings.rabbitmq_exchange
        self.queue_name: str = settings.rabbitmq_queue
    ...
    async def _setup_channel(self) -> None:
        ...
        # Process one message at a time — scene detection is CPU/IO heavy
    ...
    async def bind_routing_keys(self, routing_keys: List[str]) -> None:
        ...
        logger.info(f"✓ All routing keys bound successfully")    
